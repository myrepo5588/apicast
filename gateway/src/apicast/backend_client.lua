...
function _M:new(service, http_client)
  local endpoint =
    self.endpoint or (service and service.backend and service.backend.endpoint) or error("missing endpoint")
...
local function authrep_path(using_oauth)
  return (using_oauth and "/transactions/oauth_authrep.xml") or "/transactions/authrep.xml"
end

local function auth_path(using_oauth)
  return (using_oauth and "/transactions/oauth_authorize.xml") or "/transactions/authorize.xml"
end
